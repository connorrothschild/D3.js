...
d3
	...
	.then((data) => {
		...
		pinLabel.addEventListener('click', () => updateMarkers(pinCheck, pinMarkers));
		toggleLabel.addEventListener('click', () => updateMarkers(toggleCheck, toggleMarkers));
		box1Label.addEventListener('click', () => updateMarkers(box1Check, box1Markers));
		box2Label.addEventListener('click', () => updateMarkers(box2Check, box2Markers));
		box3Label.addEventListener('click', () => updateMarkers(box3Check, box3Markers));
		scrubLabel.addEventListener('click', () => updateMarkers(scrubCheck, scrubMarkers));
	});
